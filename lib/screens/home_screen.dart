...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static const _privacyStorageKey = 'home_values_visible';
  ...
  Future<void> _loadPrivacyPreference() async {
    final saved = await _storage.read(key: _privacyStorageKey);
    final visible = saved == null ? true : saved == 'true';
    PrivacyService.instance.valuesVisible.value = visible;
    if (!mounted) return;
    setState(() => _valuesVisible = visible);
  }

  Future<void> _setValuesVisibility(bool value) async {
    if (!mounted) return;
    setState(() => _valuesVisible = value);
    await PrivacyService.instance.setValuesVisible(value);
  }

  Future<void> _toggleValuesVisibility() async {
    await _setValuesVisibility(!_valuesVisible);
  }

  String _money(double value) {
    return _valuesVisible ? formatCurrency(value) : '••••••';
  }
  ...
  Widget _animatedMoney({
    ...
    return AnimatedSwitcher(
      ...
      child: Text(
        text,
        key: ValueKey('${_valuesVisible}_$text'),
        textAlign: textAlign,
        maxLines: 1,
  ...
  Future<void> _openMonthlyCalculation(
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => MonthlyCalculationDetailScreen(
  ...
  Future<void> _handleRefresh() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _refreshMessage = 'Dados atualizados';
  ...
  Future<void> _handleConnectAccount() async {
    ...
    if (connected == true) await _loadSummary();
  }
  ...
  int get _bankAccountsCount =>
      _accounts.where((a) => a['type'] == 'BANK').length;
  ...
  int get _creditCardsCount =>
      _accounts.where((a) => a['type'] == 'CREDIT').length;
            ...
            child: RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildFinancialCard(
                    icon: Icons.credit_card_rounded,
                    title: 'Dívida atual dos cartões',
                    value: _totalCreditCards,
    ...
    return Row(
      ...
      children: [
        ...
        _buildHeaderAction(
          ...
          tooltip: _valuesVisible ? 'Ocultar valores' : 'Mostrar valores',
            ...
            await Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) => ProfileScreen(
                  ...
                  onValuesVisibilityChanged: _setValuesVisibility,
                  onConnectionChanged: _loadSummary,
                ),
              ),
            );
            if (mounted) await _loadSummary();
                  ...
                  children: [
                    Expanded(
                      child: _buildAvailableDetail(
                        label: 'A receber',
                        value: _receivableSelectedMonth,
                      ),
                    ),
                    Container(
                      height: 38,
  ...
  Widget _buildExpectedIncomeCard() {
    return _GlassSurface(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            _buildIconBubble(icon: Icons.payments_rounded),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      color: AppTheme.inkSoft.withValues(alpha: 0.85),
                      fontSize: 11.5,
                      height: 1.25,
                    ),
                  ),
  ...
  Widget _buildIconBubble({required IconData icon}) {
    return Container(
      width: 48,
      height: 48,
      decoration: BoxDecoration(
  ...
  Widget _buildRefreshFeedback() {
    final color = _refreshIsError ? AppTheme.danger : AppTheme.success;
    return _GlassSurface(
      radius: 15,
      child: Padding(
    ...
    return _GlassSurface(
      ...
      child: const Padding(
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.add_rounded, color: AppTheme.primary, size: 21),
            SizedBox(width: 8),
            Text(
